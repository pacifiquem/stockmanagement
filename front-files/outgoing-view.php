    ...
    <div class="container grid grid-cols-6 grid-rows-6  h-screen w-screen">
        ...
        <div class="main  col-start-2 col-end-7  row-end-7 row-start-2 h-full p-2">
            <div class="search flex items-center justify-between px-10 mb-10">
                <h1 class="text-xl font-bold underline "> Outgoing</h1>
                ...
                <a href="./addproduct.php" class="py-2 px-4 bg-blue-200 ">Add a transaction</a>
            </div>
                ...
                <table class="w-full">
                    ...
                    <thead class="">
                        <tr class="mb-10    ">
                            ...
                            <th class="text-gray-600 py-4">Outgoing Id</th>
                            <th class="text-gray-600 py-4">Product Id</th>
                            <th class="text-gray-600 py-4">quantity</li>
